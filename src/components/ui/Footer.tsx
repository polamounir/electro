...
export default function Footer() {
    return (
        <footer className="bg-gray-100 border-t border-gray-400 shad shadow-[0px_-10px_50px_#17161b22]">
            <div className="mx-auto w-full px-4 py-10 sm:px-6 lg:px-8 ">
                <div className="flex justify-center text-teal-600">
                    <h2 className="text-3xl font-bold">ElECTRO</h2>
                </div>

                <p className="mx-auto mt-5 max-w-lg text-center leading-relaxed text-gray-500">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Incidunt consequuntur amet culpa cum
                    itaque neque.
                </p>

                <ul className="mt-5 flex flex-wrap justify-center gap-3 md:gap-5 lg:gap-12">
                    <li>
