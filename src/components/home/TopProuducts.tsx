...
// import { fetchTopProducts } from "@/lib/axios"
...
export default function TopProducts() {
    ...
    return (
        <div className="py-10">
            <h2 className="text-center mb-2 text-2xl font-semibold lg:text-4xl">Top Products</h2>
            <ul className="flex justify-center items-center gap-5">
                <li><button onClick={() => {
                    setViewedProducts("featured")
                    setEnd(5)
                }} className={`${viewedProducts === "featured" && "font-bold "}`} >Featured</button></li>
                <li><button onClick={() => {
                    setViewedProducts("sale")
                    setEnd(11)
                }} className={`${viewedProducts === "sale" && "font-bold "}`} >Sale</button></li>
                <li><button onClick={() => {
                    setViewedProducts("rate")
                    setEnd(17)
                }} className={`${viewedProducts === "rate" && "font-bold "}`} >Top Rate</button></li>
            </ul>
                ...
                <div className="daily-deals rounded-lg py-5 px-2 max-w-[100%]">
                    ...
                    <div className="w-[100%] ">
                        <div className="slider-container ">
                            ...
                            {Array.isArray(products) && products.length === 0 && <div className="flex justify-center">
                                <h1 className="font-semibold text-slate-300 flex items-center gap-2" >Products Comming soon
                                    <span><Command /></span>
                                </h1>
                            </div>}
